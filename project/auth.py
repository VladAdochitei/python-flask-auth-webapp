...
def login_post():
    ...
    if not user or not check_password_hash(user.password, password):
        ...
        return redirect(url_for('auth.login')) # if the user doesn't exist or the password is wrong, reload the page
...
def signup_post():
    ...
    # If a user is found, we want to redirect back to the signup page so the user can try again
    if user: 
